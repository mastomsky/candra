        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form enctype="multipart/form-data" action="<?= site_url('panel/banner/process') ?>" method="POST">
                        <div class="card-body">
                            <?= csrf(); ?>
                            <div class="form-group">
                                <input type="hidden" id="ban_id" name="ban_id" value="<?= $row->ban_id ?>">
                                <label for="foto">Foto</label>
                                <div class="image">
                                    <?php if ($page == 'edit') {
                                        if ($row->foto != null) { ?>
                                            <div class="col-md-6">
                                                <img src="<?= base_url('uploads/banner/' . $row->foto) ?>" width="200px" alt="">
                                            </div>
                                    <?php
                                        }
                                    } ?>
