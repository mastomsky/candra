    ...
    <div class="bread">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">Konsultasi Pembelian</li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select id="kebutuhan" class="form-control" required>
                                        <option hidden='hidden' selected='selected' value='default'>Pilih Kebutuhan</option>
                            ...
                            <div class="form-group">
                                ...
                                <input class="validate form-control" id="informasi" name="informasi" type="text" value="Beli" readonly style="background: #fff;" />
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <span>Nomor Handphone harus diawali dengan 62</span>
                            ...
                            <div class="form-group">
                                <button type="submit" class="konsultasi_pembelian btn btn-primary btn-rounded" id="konsultasi_pembelian"><i class="icon-ok"></i>Submit</button>
